...
@Component({
    selector: 'app-navbar',
    template: `
        <header class="navbar navbar-expand-lg fixed-top bg-light" data-aos="fade-in" data-aos-duration="1000" data-aos-offset="0">
            <div class="container">
                <!-- Navbar brand (Logo) -->
                <a class="navbar-brand pe-sm-3" routerLink="/">
                    <span class="text-primary flex-shrink-0 me-2">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="75.000000pt" height="24.000000pt" viewBox="0 0 1000.000000 300.000000" preserveAspectRatio="xMidYMid meet" style="margin-left: 0px">
                ...
                <nav class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav navbar-nav-scroll me-auto" style="--ar-scroll-height: 520px">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" routerLink="/" data-bs-toggle="collapse" (click)="toggleNavbar()">Blog(ID)</a>
                        </li>
                        <li class="nav-item">
