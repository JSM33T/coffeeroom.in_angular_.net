...
@Component({
  ...
  template: `
    <!-- hero -->
    <section
      class="bg-faded-primary d-flex min-vh-100 overflow-hidden py-2 bt-rad-1"
    >
      <div
        class="container d-flex justify-content-center pb-sm-3 py-md-4 py-xl-5"
      >
          ...
          <div class="col-lg-6 pb-5 mb-5 text-center text-lg-start">
            ...
            <div class="col-12 pb-3">
              <p
                ...
                data-aos-offset="10"
              >
                I don't feel particularly proud of myself. But when I walk alone
                in the woods or lie in the meadows, all is well.
              </p>
            </div>
            <div
              class="d-sm-flex justify-content-center justify-content-lg-start mt-lg-2"
            >
              <a
                class="btn btn-lg btn-primary w-100 w-sm-auto mb-2 mb-sm-0 me-sm-1"
                routerLink="/about"
                >About</a
              >
              <a
                class="btn btn-lg btn-link disabled"
                target="_blank"
                href="https://almondcove.in"
                >Coming soon...<i class="ai-arrow-right ms-2"></i
              ></a>
            </div>
          </div>
        </div>
      ...
      <div class="container pt-lg-2 pt-xl-4 pt-xxl-5 pb-1 pb-sm-3">
        <div class="row pt-sm-3 pt-md-4">
          ...
          <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1">
            <p class="text-body fs-xl pb-4 mb-2 mb-lg-3">
              Massa velitienes semper faucibus tristique id nibh elementum, id
              eu aliquamd diam mi tempus at laciniarty scelerisques augue at
              morbi. Arcu sit orcirs, risus mattissit laoreet.
            </p>
