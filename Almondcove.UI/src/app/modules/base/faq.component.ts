                        ...
                        <div id="faq" class="accordion">
                            <div *ngFor="let faq of faqs" class="accordion-item bg-light">
                                <h3 class="accordion-header" [attr.id]="faq.heading">
                                    <button class="accordion-button" type="button" [attr.data-bs-toggle]="'collapse'" [attr.data-bs-target]="'#' + faq.id" [attr.aria-expanded]="faq.expanded" [attr.aria-controls]="faq.id">
                                        {{ faq.question }}
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" [class.show]="faq.expanded" [attr.id]="faq.id" [attr.aria-labelledby]="faq.heading" data-bs-parent="#faq">
