        ...
        <section class=" position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
            ...
            <div class="container position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
                <div class="display-3 text-center text-primary mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px;">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="300.000000pt" height="70.000000pt" viewBox="0 0 1000.000000 300.000000" preserveAspectRatio="xMidYMid meet" style="margin-left: 0px;">
        ...
        <section class="container pt-5 pb-5 mb-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            <div class="pt-4 pt-sm-3 mt-md-3">
                <h1 class="pb-3 mb-2 mb-sm-3 mb-lg-4" data-aos="flip-up" data-aos-duration="300">
                    Hi this is
                    <span class="text-primary">Jass</span>
                </h1>
