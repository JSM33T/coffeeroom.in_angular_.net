    ...
    template: `
        ...
        <div class="offcanvas offcanvas-end" id="customizer" data-bs-scroll="true" tabindex="-1">
            ...
            <div class="offcanvas-body">
                ...
                <div class="mb-4">
                    <label class="d-flex w-100 text-dark fs-sm fw-medium pt-1 mb-2" for="border-width">Fixed favicon</label>
                </div>
